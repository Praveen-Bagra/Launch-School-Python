...
class TestTodoList(unittest.TestCase):
    ...
    def test_to_list(self):
        ...
        self.assertIsNot(self.todos._todos, self.todos.to_list())
    ...
    def test_add_invalid(self):
        self.assertRaises(TypeError, self.todos.add, "Buy register")
    ...
    def test_mark_done_at(self):
        ...
        self.assertEqual(True, self.todos.first().done)
    ...
    def test_each(self):
        ...
        lst = []
        def add_status(todo):
            lst.append(todo.done)

        self.todos.each(add_status)
        self.assertEqual([True, False, False], lst)
        
    def test_select(self):
        self.todos.mark_done_at(2)

        todolist_dones = self.todos.select(lambda todo: todo.done)
        self.assertEqual([self.todo3], todolist_dones.to_list())
        self.assertEqual(3, len(self.todos))
