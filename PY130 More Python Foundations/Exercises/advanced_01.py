# - Initialize sentence = ''
# - Initialize max_word_count = 0
# - Initialize max_word_count_sentence = None

# - Iterate over the words.
# - add word to sentence
# - If word endswith '.', '!' or '?'
#       - check sentence word count, if is more than max_word_count:
#           - Reassign max_word_count = sentence_word_count
#           - Reassign max_word_count_sentence = sentence
#           - Reassign sentence = ''

# - Return max_word_count_sentence
    ...
    for word in words:
        ...
        if word.endswith('.') or word.endswith('!') or word.endswith('?'):
            ...
            if current_word_count > max_word_count:
                ...
                max_word_count_sentence = sentence
